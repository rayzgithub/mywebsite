...
$info = $wpdb->get_results("select answer.excerpt,answer.content,question.name,question.keywords,answer.answer_id,answer.ans_url from zhihu_answer as answer left join zhihu_question as question on answer.question_id=question.question_id where answer.is_post = 0",ARRAY_A);
